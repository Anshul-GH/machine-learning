...
model_location = '../out/chatbot_model.h5'
...
def clean_up_sentences(sentence):
    ...
    # stem for each word - create short form for the word
...
def predict_class(sentence, model):
    # filter out the predictions that are below a certain threshold
...
base= Tk()
base.title("Chatbot Application")
...
# creating the box where we will enter the message
