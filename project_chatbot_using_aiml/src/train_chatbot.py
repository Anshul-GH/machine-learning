...
for doc in documents:
    ...
    bag = []
    # create the list of tokenized words for the pattern
    pattern_words = doc[0]

    # lemmatize each word - create base words, in attempt to represent related word
    pattern_words = [lemmatizer.lemmatize(word.lower()) for word in pattern_words]

    # create the bag of words array with 1, if a word match is found in the current pattern
    for word in words:
...
# shuffle the features and turn them into an array
